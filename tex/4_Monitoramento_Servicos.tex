...
\begin{figure}[h!]
    \begin{minted}
    [frame=lines,framesep=5mm,baselinestretch=1.0,linenos]{erlang}
    ...
    \end{minted}
    \caption{Exemplode identificadores das métricas no Erlangms.}
...
\begin{figure}[h!]
    \begin{minted}
    [frame=lines,framesep=5mm,baselinestretch=1.5,linenos]{erlang}
...
\begin{figure}[h!]
	\begin{center}
	\includegraphics[scale = 0.59]{img/webserviceStats.png}
