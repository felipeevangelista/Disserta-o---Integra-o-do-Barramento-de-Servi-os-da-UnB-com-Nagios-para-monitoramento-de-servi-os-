...
\begin{itemize}
    ...
    \item Agente de monitoramento - Coletor de informações e dados de monitoramento e transmissor de informações e dados de monitoramento para a ferramenta de monitoramento.
\end{itemize}
...
O agente de monitoramento é representado pelo Exometer que é um \textit{framework} que executa instrumentação e permiti a exportação de dados, foi implementado em Erlang. Neste trabalhos foi utilizado o módulo SNMP da ferramenta para realizar a integração do barramento de serviços e a ferramenta de monitoramento.

Com o conceito arquitetural definido, este trabalho emprega ênfase na integração dos componentes.   
